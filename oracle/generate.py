...
Usage:
  python -m oracle.generate "coot::molecule_t::get_bonds_mesh"
  python -m oracle.generate "coot::molecule_t::get_bonds_mesh" --model gemma4:31b
  python -m oracle.generate "coot::molecule_t::get_bonds_mesh" --dry-run
...
OUT_ROOT      = Path(__file__).parent.parent / "oracle-data"
...
def generate_one(
    ...
    if agent:
        oracle_code, trace = generate_with_agent(conn, function_qname, model, verbose=verbose)
